...
String writeAPIKey = "QYBTY2UU44K8K2DI";
...
void loop()
{
  ...
  String analogValue0 = String(random(500, 1023), DEC);
  String analogValue1 = String(random(200, 1023), DEC);
  String analogValue2 = String(random(0, 800), DEC);
  String analogValue3 = String(random(214,234), DEC);
  ...
  {
    updateThingSpeak("field1=" + analogValue0+"&field2="+analogValue1+"&field3="+analogValue2+"&field4="+analogValue3);
  }
